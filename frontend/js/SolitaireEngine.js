...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _deckGenerator = __webpack_require__(91);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toggleSpecialStepMode = function toggleSpecialStepMode(data) {
		...
		var el = (0, _elRender2.default)(_share2.default.get('domElement:field'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _autoMoveToHome = __webpack_require__(64);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tips5 = __webpack_require__(9);
	
	var _tips6 = _interopRequireDefault(_tips5);
	...
	exports.default = function (moveDeck, cursorMove) {
		...
		var _tips = _tips6.default.getTips();
		for (var i in _tips) {
		...
		if (_autoTips.length > 1) {
			...
			for (var _i in _autoTips) {
				...
				var _cardsCount = _autoTips[_i].to.deck.cardsCount();
				var _destination_deck_position = null;
	
				if (_cardsCount) {
					// координаты последней карты стопки назначения
					_destination_deck_position = _autoTips[_i].to.deck.padding(_cardsCount);
				} else {
					// координаты стопки назначения
					_destination_deck_position = _autoTips[_i].to.deck.getPosition();
				}
	
				// координаты центра стопки назначения
				var center_to = {
					"x": _destination_deck_position.x + (_defaults2.default.card.width / 2 | 0),
					"y": _destination_deck_position.y + (_defaults2.default.card.height / 2 | 0)
				};
	
				// расстояние между стопкой и перетаскиваемой картой/стопкой
				_autoTips[_i].distance = Math.sqrt(function (i) {
					return i * i;
			...
			if (_autoTips[0].distance > inDistance) {
				...
				if (_homeGroups.length) {
					...
					for (var homeGroupIndex in _homeGroups) {
						...
						for (var _i2 in _autoTips) {
							if (_autoTips[_i2].to.deck.parent == _homeGroups[homeGroupIndex]) {
								_tips2.push(_autoTips[_i2]);
							}
						}
					}
				...
				for (var _i3 = 0; _i3 < _autoTips.length; _i3 += 1) {
	
					var _tips3 = [];
	
					if (_autoTips[_i3].to.deck.cardsCount()) {
						_tips3.push(_autoTips[_i3]);
					}
				...
				if (_in_direction_count == 0) {
					...
					var _tips4 = _autoTips.filter(function (e) {
						return e.inHorisontalDirection;
					});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _addAutoSteps = __webpack_require__(60);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _groupFill = __webpack_require__(47);
	
	var _groupFill2 = _interopRequireDefault(_groupFill);
	
	var _groupRedraw = __webpack_require__(48);
	
	var _groupRedraw2 = _interopRequireDefault(_groupRedraw);
	
	var _groupGenerator = __webpack_require__(49);
	...
	var PARAMS = {
		...
		"autoCheckFlip": {
			"type": 'boolean',
			"default": _defaults2.default.autoCheckFlip
		}
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _deckTake = __webpack_require__(41);
	
	var _deckTake2 = _interopRequireDefault(_deckTake);
	
	var _deckPut = __webpack_require__(42);
	
	var _deckPut2 = _interopRequireDefault(_deckPut);
	
	var _genCardByName2 = __webpack_require__(43);
	...
	var _deckCardNames = __webpack_require__(44);
	
	var _deckCardNames2 = _interopRequireDefault(_deckCardNames);
	
	var _getDeck = __webpack_require__(45);
	
	var _getDeck2 = _interopRequireDefault(_getDeck);
	
	var _applyChangedParameters = __webpack_require__(46);
	
	var _applyChangedParameters2 = _interopRequireDefault(_applyChangedParameters);
	...
	var deckClass = function () {
		function deckClass(data, id) {
			...
			var __data = (0, _applyChangedParameters2.default)({
				"deckData": data,
				"deck": this,
				"params": this._params
			}, false);
		...
		_createClass(deckClass, [{
			...
			value: function Push(deck) {
				...
				(_cards2 = this.cards).splice.apply(_cards2, [visibleCardsCount, 0].concat(_toConsumableArray(deck))); // TODO maybe concat faster than "..."?; is faster that concat+splices
			...
			key: 'genCardByName',
			value: function genCardByName(name, last) {
				return (0, _genCardByName3.default)(this, name, last);
			}
		}, {
			key: 'hide',
			value: function hide() {
...
/***/ (function(module, exports) {
	...
	var flipTypes = {
		...
		"topUnflip": function topUnflip(i, length, data, deck) {
	
			var _result = flipTypes._direction_type("top", "unflip", i, length, data);
				...
				for (var deckId in moveDecks) {
					...
					if (_canStep && dealDeck.cards.length > 0) {
						(function () {
							...
							(0, _forceMove2.default)(forceMoveData, true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var forceMove = function forceMove(_ref) {
		var from = _ref.from,
		    to = _ref.to,
		    deck = _ref.deck,
		    flip = _ref.flip,
		...
		// departure (from)
		var deckFrom = typeof from == 'string' ? _deck2.default.getDeck(from) : from;
	
		// destination (to)
		var deckTo = typeof to == 'string' ? _deck2.default.getDeck(to) : to;
		...
		for (var i in deckFromCards) {
			...
			if (i >= deckFromCards.length - deck.length) {
				...
				var _index = i - (deckFromCards.length | 0) + (deck.length | 0);
	
				if (deck[_index] && deckFromCards[i].name != deck[_index]) {
		...
		if (check) {
			...
			var breakForceMove = function breakForceMove(e) {
	
				if (_share2.default.get('inHistoryMove')) {
					return;
				}
	
				var _cards = deckTo.Pop(deck.length);
				...
				if (cardsPop) {
					...
					if (steps && steps.length) {
						...
						_event2.default.dispatch('deleteHistory', steps);
					}
				}
			};
			...
			var forceMoveCallback = function forceMoveCallback(e) {
	...
	_event2.default.listen('forceMove', forceMove);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var undo = function undo(data) {
		...
		if (flip) {
			var deckName = flip.deckName,
			    cardIndex = flip.cardIndex,
			    cardName = flip.cardName;
	
	
			var deck = _common2.default.getElementByName(deckName);
	
			var card = deck && deck.getCardByIndex(cardIndex | 0);
		...
		// undo unflip
		if (unflip) {
			var _deckName = unflip.deckName,
			    _cardIndex = unflip.cardIndex,
			    _cardName = unflip.cardName;
	
	
			var _deck = _common2.default.getElementByName(_deckName, 'deck');
	
			var _card = _deck && _deck.getCardByIndex(_cardIndex | 0);
		...
		// undo hide
		if (hide) {
			var _deckName2 = hide.deckName,
			    _cardIndex2 = hide.cardIndex,
			    _cardName2 = hide.cardName;
	
	
			var _deck2 = _common2.default.getElementByName(_deckName2, 'deck');
	
			var _card2 = _deck2 && _deck2.getCardByIndex(_cardIndex2 | 0);
	
			if (_card2 && _card2.name == _cardName2) {
				_card2.visible = true;
				_deck2.Redraw();
			} else {
		...
		// undo show
		if (show) {
			var _deckName3 = show.deckName,
			    _cardIndex3 = show.cardIndex,
			    _cardName3 = show.cardName;
	
	
			var _deck3 = _common2.default.getElementByName(_deckName3, 'deck');
	
			var _card3 = _deck3 && _deck3.getCardByIndex(_cardIndex3 | 0);
	
			if (_card3 && _card3.name == _cardName3) {
		...
		if (typeof lock != 'undefined') {
			for (var i in lock) {
				var _element = _common2.default.getElementsByName(lock[i])[0];
				_element.unlock();
			}
		}
		...
		if (typeof unlock != 'undefined') {
			for (var _i2 in unlock) {
				var _element2 = _common2.default.getElementsByName(unlock[_i2])[0];
				_element2.lock();
			}
		}
		...
		// redo swap
		if (swap) {
			var _deckName4 = swap.deckName,
			    fromIndex = swap.fromIndex,
			    toIndex = swap.toIndex;
	
	
			var _deck4 = _deckName4 && _common2.default.getElementByName(_deckName4, 'deck');
		...
		if (move) {
			...
			var from = move.from,
			    ...
			    _deck5 = move.deck,
			    _flip = move.flip,
			    _stepType = move.stepType;
	
	
			if (_stepType) {
	
				if (typeof _stepType == 'string') {
					_share2.default.set('stepType', _stepType);
				}
	
				if (typeof _stepType.undo == 'string') {
					_share2.default.set('stepType', _stepType.undo);
				}
			}
			...
			if (typeof _flip == "boolean") {
				forceMoveData.flip = !_flip;
			}
		...
		if (markCard) {
			var _deckName5 = markCard.deckName,
			    _cardIndex4 = markCard.cardIndex,
			    _cardName4 = markCard.cardName;
	
	
			var _deck6 = _common2.default.getElementByName(_deckName5, 'deck');
	
			var _card4 = _deck6.getCardByIndex(_cardIndex4 | 0);
	
			if (_card4 && _cardName4 == _card4.name) {
		...
		if (unmarkCard) {
			var _deckName6 = unmarkCard.deckName,
			    _cardIndex5 = unmarkCard.cardIndex,
			    _cardName5 = unmarkCard.cardName;
	
	
			var _deck7 = _common2.default.getElementByName(_deckName6, 'deck');
	
			var _card5 = _deck7.getCardByIndex(_cardIndex5 | 0);
	
			if (_card5 && _cardName5 == _card5.name) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var redo = function redo(data) {
		...
		if (hide) {
			...
			if (_card2 && _card2.name == _cardName2 // TODO check
			) {
		...
		if (move) {
			...
			if (move.stepType) {
				...
				if (typeof stepType.redo == 'string') {
					_share2.default.set('stepType', stepType.redo);
				}
			}
		...
		if (setStepType) {
			...
			if (typeof setStepType == "string") {
				_share2.default.set('stepType', setStepType);
			} else {
				if (typeof setStepType.redo == "string") {
					_share2.default.set('stepType', setStepType.redo);
				}
			}
		}
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_event2.default.listen('addStep', function (data) {
		...
		if (data.step) {
			...
			var stepId = _history3.default.add(data.step);
	
			if (typeof data.callback == "function") {
				data.callback(stepId);
			}
		} else {
			_history3.default.add(data);
		}
	});
	...
	_event2.default.listen('saveSteps', function (e) {
		...
		var data = _history3.default.get();
	...
	_event2.default.listen('scanAttempts', function (data) {
		...
		_snapshot2.default.applyState(summary, { "flip": "prevFlip" });
	});
	
	_event2.default.listen('resetHistory', function (e) {
		_history3.default.reset();
	});
	
	_event2.default.listen('deleteHistory', function (steps) {
		_history3.default.delete(steps);
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var snapshot = function () {
		...
		_createClass(snapshot, [{
			...
			key: 'getInStateByUid',
			value: function getInStateByUid(state, uid) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lockActionCommon = __webpack_require__(37);
							...
							for (var i = data.history.length - 1; i >= 0 && !found; i -= 1) {
								...
								for (var atomIndex in step) {
									...
									if (!found && typeof atom.rollerActionStart == "string" && atom.rollerActionStart == deck.name) {
										...
										// Swap
										for (var _i2 = 0; _i2 < (_unflipCardsCount / 2 | 0); _i2 += 1) {
	
											var _next = _unflipCardsCount - _i2 - 1;
										...
										for (var _i3 = 0; _i3 < _unflipCardsCount; _i3 += 1) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var applyChangedParameters = function applyChangedParameters(data) {
		var rewrite = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
	
	
		var _data = rewrite ? data : JSON.parse(JSON.stringify(data));
	
		_data.params.x = ((_data.deckData.position && typeof _data.deckData.position.x == 'number' ? _data.deckData.position.x : 0) | 0) + ((_data.deckData.parentPosition && typeof _data.deckData.parentPosition.x == 'number' ? _data.deckData.parentPosition.x : 0) | 0);
	
		_data.params.y = ((_data.deckData.position && typeof _data.deckData.position.y == 'number' ? _data.deckData.position.y : 0) | 0) + ((_data.deckData.parentPosition && typeof _data.deckData.parentPosition.y == 'number' ? _data.deckData.parentPosition.y : 0) | 0);
	
		_data.deck.rotate = _data.params.rotate = _data.deckData.rotate && typeof _data.deckData.rotate == 'number' ? _data.deckData.rotate : 0;
		...
		for (var key in paddingValues) {
			...
			_data.params[value] = _data.deckData[key] && typeof _data.deckData[key] == 'number' ? _data.deckData[key] : _data.deckData.paddingType ? _defaults2.default[value] : 0;
		}
	
		return _data;
	};
	
	exports.default = applyChangedParameters;
	...
	exports.default = function (group, cardNames) {
		...
		if (_checkDeck) {
			...
			for (var _i7 in cardNames) {
				...
				group.decks[_index3].genCardByName(cardNames[_i7]); // , i == cardNames.length - 1);
			}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _countGenerator = __webpack_require__(50);
	
	var _countGenerator2 = _interopRequireDefault(_countGenerator);
	
	var _fanGenerator = __webpack_require__(51);
	
	var _fanGenerator2 = _interopRequireDefault(_fanGenerator);
	
	var _mapGenerator = __webpack_require__(52);
	
	var _mapGenerator2 = _interopRequireDefault(_mapGenerator);
	
	var _lineGenerator = __webpack_require__(59);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _relationsGenerator = __webpack_require__(53);
	
	var _relationsGenerator2 = _interopRequireDefault(_relationsGenerator);
	
	var _mapCommon = __webpack_require__(55);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fallAutoStep = __webpack_require__(61);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _autoStep2 = __webpack_require__(62);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var autoMoveToHome = function autoMoveToHome(e) {
		...
		if (suitableTips.length > 0) {
			...
			var autoMoveToHomeCallback = function autoMoveToHomeCallback(e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gamePreferences = __webpack_require__(68);
	...
	var onShowParameters = function onShowParameters(e) {
		...
		try {
			for (var prefName in _defaults2.default.themes) {
				...
				document.querySelector('input[name="pref_' + prefName + '"][value="' + _pref.toString() + '"]').setAttribute('checked', true);
			}
		} catch (e) {}
	...
	var applyParameters = function applyParameters(e) {
		...
		try {
			...
			for (var prefName in _defaults2.default.themes) {
				...
				var _value = document.querySelector('input[name="pref_' + prefName + '"]:checked').value;
	...
	exports.default = function (e) {
		...
		try {
			...
			document.getElementById('parametersPanel').addEventListener('change', function (e) {
				e.target.nodeName == 'INPUT' ? applyParameters() : null;
			});
		...
		_createClass(gamePreferences, [{
			...
			value: function draw() {
				...
				for (var prefName in _preferences) {
					...
					for (var i in _preferences[prefName].options) {
						...
						var _labelInner = document.createElement('label');
			...
			value: function show(pref) {
				...
				for (var prefName in _preferences) {
					if (pref && typeof pref[prefName] != 'undefined') {
						...
						document.querySelector('input[name="gamePref_' + prefName + '"][value="' + pref[prefName].toString() + '"]').setAttribute('checked', true);
					} else {
	
						// $(`input[name='gamePref_${prefName}'][value='${(_preferences[prefName].value).toString()}']`)
						// 	.prop({ "checked": true });
	
						document.querySelector('input[name="gamePref_' + prefName + '"][value="' + _preferences[prefName].value.toString() + '"]').setAttribute('checked', true);
					}
				}
			}
		}, {
			...
			value: function get(pref) {
				...
				for (var prefName in _preferences) {
					...
					var _value = document.querySelector('input[name="gamePref_' + prefName + '"]:checked').value;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showFlipCardOnMove = function showFlipCardOnMove(data) {
		...
		var deck = _common2.default.getElementById(data.toCard.parent);
	
		if (!deck || !deck.autoUnflipTop) {
			return;
		}
		...
		for (var i in tips) {
			...
			var fromDeck = _common2.default.getElementById(tips[i].from.card.parent);
			if (fromDeck && fromDeck.name == deck.name) {
				inTips = true;
			}
		}
		...
		var cardIndex = deck.getCardIndexById(data.toCard.id);
		var moveDeckCount = deck.cards.length - cardIndex;
	
		var prevCard = deck.cards.length > moveDeckCount ? deck.cards[deck.cards.length - moveDeckCount - 1] : null;
	...
	_event2.default.listen('click:unflipCard', showFlipCardOnMove);
	    ...
	    */
				...
				if (_animation) {
					...
					try {
						...
						// TODO
						var top = params.top ? Math.abs(noPX(params.top) - noPX(this.el.style.top)) : 0;
						var left = params.left ? Math.abs(noPX(params.left) - noPX(this.el.style.left)) : 0;
						...
						for (var attrName in params) {
							...
							if (reType(this.el.style[attrName]) != reType(params[attrName]) && // old style not new style 
							function (el, attr) {
								return ['left', 'top'].indexOf(attr) >= 0 // параметр left или top
								? parseInt(_this.el['offset' + attr[0].toUpperCase() + attr.slice(1)]) != parseInt(params[attr]) // offset not old style
								: true;
	     ...
	     */
					...
					try {
						...
						for (var _attrName in params) {
	
							if (reType(this.el.style[_attrName]) != reType(params[_attrName])) {
								counter += 1;
							}
							this.el.style[_attrName] = params[_attrName];
						}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _drawDeck = __webpack_require__(79);
	
	var _drawDeck2 = _interopRequireDefault(_drawDeck);
	
	var _drawCard = __webpack_require__(80);
	
	var _drawCard2 = _interopRequireDefault(_drawCard);
	
	var _drawTip = __webpack_require__(81);
	
	var _drawTip2 = _interopRequireDefault(_drawTip);
	
	var _moveDragDeck = __webpack_require__(82);
	
	var _moveDragDeck2 = _interopRequireDefault(_moveDragDeck);
	
	var _moveCardBack = __webpack_require__(83);
	
	var _moveCardBack2 = _interopRequireDefault(_moveCardBack);
	
	var _fieldThemesSet = __webpack_require__(84);
	...
	_event2.default.listen('clickCard', function (card) {
		...
		var deck = _common2.default.getElementById(card.parent);
		...
		for (var _i in data.cards) {
			...
			for (var _class in data.cards[_i].classList) {
				...
				if (data.cards[_i].classList[_class] === true) {
					...
					(0, _elRender2.default)(_cardDomElement2).removeClass(_class);
				}
			}
	
			// elRender(_cardDomElement)
			// 	.css(_params);
			for (var paramName in _params2) {
				_cardDomElement2.el.style[paramName] = _params2[paramName];
			}
		}
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Move card to home
	_event2.default.listen('moveCardBack', function (data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _winCheckRules = __webpack_require__(90);
	...
	var winCheckRules = {
		...
		"group": function group(data) {
			...
			for (var deckName in data.decks) {
				...
				if (typeof data.filterArgs == 'string' && data.decks[deckName].parent == data.filterArgs || data.filterArgs.length && data.filterArgs.indexOf(data.decks[deckName].parent) >= 0) {
					decksLength += 1;
		...
		"deck": function deck(data) {
			...
			for (var deckName in data.decks) {
				if (typeof data.filterArgs == 'string' && data.decks[deckName].name == data.filterArgs || data.filterArgs.indexOf(data.decks[deckName].name) >= 0) {
					decksLength += 1;
					decks[deckName] = data.decks[deckName];
				}
			}
		...
		"_asc_desk": function _asc_desk(data) {
			...
			for (var deckName in data.decks) {
				...
				var cards = data.decks[deckName].cards;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var logCardsInDeck = function logCardsInDeck(deck) {
		...
		var _log = [deck.name + ' (' + deck.cards.length + '): '];
