...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.version = (9091495043).toString().split(9).slice(1).map(function (e) {
		return parseInt(e, 8);
	}).join('.');
	...
	var Deck = function () {
		function Deck(data, id) {
			...
			this.padding = function (index) {
				return padding(_this._params, _this.cards[index], index, _this.cards.length, _this.cards, paddingData);
			};
